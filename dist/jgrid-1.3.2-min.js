...
goog.qe = function(d, g, c) {
  ...
  for(var b;d.length && (b = d.shift());) {
    !d.length && goog.Kg(g) ? c[b] = g : c = c[b] ? c[b] : c[b] = {}
  }
};
goog.D = function(d) {
...
goog.$i = function(d, g) {
  return d instanceof Object ? Object.prototype.propertyIsEnumerable.call(d, g) : goog.dh(d, g)
};
goog.Kg = function(d) {
  return d !== s
};
...
goog.Gg = function(d) {
  return d[goog.Hb] || (d[goog.Hb] = ++goog.qh)
};
goog.kh = function(d) {
...
goog.bind = function(d, g, c) {
  goog.bind = Function.prototype.bind && Function.prototype.bind.toString().indexOf("native code") != -1 ? goog.pg : goog.og;
...
(function() {
  ...
  z.getHead = function() {
    return document.Hg ? document.Hg : document.getElementsByTagName("head")[0]
  };
  ...
  z.calCheckSize = function() {
    ...
    b.rg = a.childNodes[0].offsetWidth;
    b.qg = a.childNodes[0].offsetHeight;
    a.innerHTML = "<input type='radio' style='margin:0;padding:0;overflow:hidden'/>";
    b.fh = a.childNodes[0].offsetWidth;
    b.eh = a.childNodes[0].offsetHeight;
  ...
  z.open = function(b) {
    ...
    b = z.ifNull(a.height, "", "height=" + a.height + ", ") + z.ifNull(a.left, "", "left=" + a.left + ", ") + z.ifNull(a.top, "", "top=" + a.top + ", ") + z.ifNull(a.width, "", "width=" + a.width + ", ") + "channelmode=" + a.ci + ", directories=" + a.directories + ", fullscreen=" + a.oi + ", location=" + a.location + ", menubar=" + a.menubar + ", resizable=" + a.mh + ", scrollbars=" + a.scrollbars + ", status=" + a.status + ", titlebar=" + a.gj + ", toolbar=" + a.toolbar;
...
(function() {
  function d(c) {
    ...
    this.Og.zi(this.key) && r(Error("Duplicate column key!" + b));
    ...
    this.Rg = !!c.noSearch;
    this.ph = !!c.tooltipEnabled;
    this.di = c.colClass + "" || t;
    this.style = c.style + "" || t;
    this.Ig = c.headerStyle + "" || t;
...
(function() {
  function d(a) {
    ...
    this.B = {nb:0, Oa:1, Fa:2, wa:this.C + "@NR" + c.random(1E4), Q:0, qc:1, ad:2, bd:3, Ba:4, Vc:5, rh:0, Sg:1, nh:2, "boolean":3, wg:4, "enum":5};
  ...
  var b = d.prototype;
  b.N = function(a) {
    for(var e = 0, f = this.A.uniqueKeys, b, h = this.na, j = f.length, d = this.Mg, g = this.grid.colDefMgr.getAll();e < j;e++) {
      b = f[e], typeof b === "string" && (h[b] = {})
    }
    j = g.length;
    for(e = 0;e < j;e++) {
      f = g[e], b = f.key, f.hasOwnProperty("unique") && f.unique === !0 && !h.hasOwnProperty(b) && (h[b] = {}), d[b] = this.Pg(f.type)
    }
    c.ifNull(a.datalist, []);
    this.bindEvents();
    this.set(a.datalist)
  ...
  b.Ka = function(a, e, f, b, h) {
    ...
    return n.length === 0 ? !1 : {U:n, bi:q, ng:p}
  };
  b.we = function(a, e, f) {
  ...
  b.update = function(a, e, b) {
    ...
    if((h = this.wh(a, e, i)) instanceof Error) {
      return this.bc(a, i), h
    }
    if((h = this.th(a, e, i)) instanceof Error) {
      return this.bc(a, i), h
    }
  ...
  b.updateList = function(a, e) {
    ...
    if((d = this.vh(b, h, i)) instanceof Error) {
      return this.cc(b, i), d
    }
    if((d = this.uh(b, h, i)) instanceof Error) {
      return this.cc(b, i), d
    }
    d !== !1 && this.grid.event.trigger("onIdListChange", [d.list, d.ng, this.M]);
    if(c.isNull(e) || e.undo !== !0) {
  ...
  b.ec = function(a) {
    ...
    if(!c.isNull(a)) {
      ...
      c.isNotNull(a.tg) ? (e.sort(a.tg), a.fc && e.reverse()) : c.isNotNull(a.Ng) && this.constructor.pf(e, a.Ng, a.fc);
...
(function() {
  ...
  b.register = function(a, e, b) {
    if(c.isString(a)) {
      ...
      if(c.isNotNull(a.pe)) {
        this.yb(a.pe, a.Dg, a.oh)
      }else {
        for(var i, e = a.length, h;i < e;i++) {
          c.isNotNull(h = a[i]) && this.yb(h.pe, h.Dg, h.oh)
        }
      }
    }
  };
...
(function() {
  ...
  a.destroy = function() {
    try {
      c.isEmptyObj(g.m.Grid) && g.jg(), this.event.trigger("onDestroy"), g.H(this, {name:"Grid", Qg:"event", $:"ctnr", map:"vars _options", style:"style _dynStyle"})
    }catch(a) {
      return a
    }
  };
...
(function() {
  ...
  b.vf = function(a, b) {
    if(b.getColDef().ph && c.isNull(this.Ua)) {
...
(function() {
  ...
  b.bindEvents = function() {
    this.grid.event.bind({onCreateCss:this.Y, onDestroy:this.H, onDataChange:[this.de, this.kg], onAfterRefresh:this.ce}, this)
  };
  b.H = function() {
    var a, b = this.Zc;
    for(a in b) {
...
(function() {
  ...
  b.bindEvents = function() {
    this.grid.event.bind({onGetCellClass:this.Hf, onCreateCss:this.Y, onDestroy:this.H, keydownCanvas:this.sb, dragoverCanvas:this.Te, mousedownCanvas:this.sf, onBeforeRerender:this.Af, onAfterRerender:this.Ug, onBeforeDataChange:this.Vg}, this)
  };
  b.H = function() {
...
(function() {
  ...
  a.bindEvents = function() {
    var a = {onGetColCellClass:this.If, keydownCanvas:this.sb, onDestroy:this.H, dblclickCanvas:this.wc, onCreateDynamicCss:this.Wg, "onBeforeNavigate onBeforeRefresh onBeforeSelect":this.commit, onBeforeFocusCanvas:this.notActive};
    b.isNull(this.grid.selMgr) ? a.Ti = this.Sd : a.Qi = this.Sd;
    if(this.A.deleteEnabled) {
      a["keydownSel_" + b.keyMapKeydown.yg] = this.Me
    }
  ...
  a.sb = function(a) {
    this.active() ? a.which === b.keyMapKeydown.Bg && this.cancel() : !a.ctrlKey && !a.altKey && b.isNotNull(this.grid.selMgr) && (a.which === b.keyMapKeydown.yg && this.A.deleteEnabled ? this.Le(this.grid.selMgr.getCell()) : this.De[a.which] ? this.begin(this.grid.selMgr.getCell()) : a.which === b.keyMapKeydown.ni && (a.preventDefault(), this.begin(this.grid.selMgr.getCell())))
  };
  a.active = function() {
        ...
        if(c.hasOwnProperty(g) && g !== "length") {
          for(q in k = m = l = s, n = c[g], n) {
            if(n.hasOwnProperty(q) && !(q === "length" || f.hasOwnProperty(q))) {
              ...
              o = b.isNotNull(a[q]) ? a[q].vg : o.getDatarow();
...
(function() {
  ...
  b.bindEvents = function() {
    ...
    for(a = {onRenderModules:this.wb, onAfterRenderModules:this.Rc, onCreateCss:this.Y, onDestroy:this.H, mousedown:this.tb, mouseup:this.Ia, dragmove:this.Se, onScrollViewportH:this.Mf, onScrollViewportV:this.Nf, onChangeSorter:this.Bf, click:this.pb, onResizeCol:this.hg};d < f;d++) {
  ...
  b.Y = function() {
    ...
    for(c.push(a + b.classResizeGuide + "{z-index:10;position:absolute;background:" + b.resizeBackground + ";width:" + b.resizeGuideWidth + "px}");l < g;l++) {
      c.push(a + b.classColHeader + "#" + this.C + "h" + d[l].key + "{" + d[l].Ig + "}")
    }
    return c.join("")
  };
  b.cd = function() {
  ...
  b.Zd = function(a) {
    ...
    for(var b = this.grid.view.ka, f = this.grid.colDefMgr.get(), d = f.length, g = this.fb, j;a < d;a++) {
      if(j = f[a].key, g.hasOwnProperty(j)) {
        g[j][0].style.left = b[a + 1] + this.ag + "px"
      }
    }
  };
  b.wf = function(a, b) {
  ...
  b.lf = function() {
    for(var a = this.grid.colDefMgr.get(), b = a.length, f = this.grid.view.ka, c = this.A, d = this.fb, g, l = 0, m = this.ag = Math.floor(c.scrollerLeft - c.resizeHandleWidth / 2), k = this.grid.view.C, o = c.classResizeHandle, n = this.Ha;l < b;l++) {
...
(function() {
  ...
  b.N = function() {
    ...
    if(c.isNull(b.uc)) {
      a = c.calCheckSize(), b.uc = a.rg, b.yd = a.qg, b.Ud = a.fh, b.Td = a.eh
    }
    this.bindEvents()
  };
  b.bindEvents = function() {
  ...
  b.disable = function(a, b) {
    ...
    c.hasOwnProperty(f) || (c[f] = a, d.zg(this.getCheckbox(a)), this.grid.event.trigger("onDisableCheck", [a]))
  };
  b.enable = function(a, b) {
    var f = this.grid.dataMgr;
    b || (a = this.grid.dataMgr.map(a));
    var f = f.getId(a), c = this.kb;
    c.hasOwnProperty(f) && (delete c[f], d.Ag(this.getCheckbox(a)), this.grid.event.trigger("onEnableCheck", [a]))
  };
  b.be = function() {
    this.A.master && d.fg(this.sa, this.isCheckedAll())
  };
  b.Q = function(a) {
...
(function() {
  ...
  a.H = function() {
    g.H(this, {name:"Collapser", path:"collapser", Qg:"tree", $:"master", ya:"checkMgr", map:"options"})
  };
  a.Y = function() {
...
(function() {
  ...
  b.bindEvents = function() {
    var a;
    a = {onBeforeSetDatalist:this.Uf, "onAfterSetDatalist onAddDatalist":this.Sc, onAddDatarow:this.ub, onUpdateDatarow:this.Yb, onUpdateDatalist:this.Xb, onRemoveDatarow:this.Qa, onRemoveDatalist:this.eb, onDestroy:this.H};
...
(function() {
  ...
  b.N = function() {
    ...
    this.grid.event.bind({canvasFind:this.wd, onCreateCss:this.Y, onCreateDynamicCss:this.Ef, onDestroy:this.Ff, keydown:this.Hc, keyup:this.Kc, keypress:this.Jc, mousein:this.Nc, mouseout:this.Pc, mouseenter:this.Mc, mouseleave:this.Oc, mousemove:this.cb, mouseover:this.Qc, mousedown:this.tb, mouseup:this.Ia, click:this.pb, dblclick:this.vc, resizeWidth:this.gg, "resizeWidth onResizeCol onResizeCanvasHeight":this.bg, onAfterRefresh:this.Tg, onRenderModules:this.zb, onReorderCols:this.Lf, onResizeCanvasWidth:this.Xd, 
    onUpdateDatarow:this.bh, onUpdateDatalist:this.ah, onRemoveDatarow:this.$g, onRemoveDatalist:this.Zg, onIdChange:this.Xg, onIdListChange:this.Yg, unsetDrag:this.sh}, this)
  };
  b.sh = function() {
    this.J.drag = !1
  };
  ...
  b.Fe = function() {
    return this.A.autoHeight ? this.tc() + (this.grid.width() < this.ud() ? this.grid.J.xe.yi : 0) : this.pa() * this.A.rowsPerPage
  };
  ...
  b.setWidthByKey = function(a, b) {
    ...
    if(b !== d.width) {
      var g = d.width;
      d.width = b;
      this.eg(this.Yc(this.grid.colDefMgr.getIdxByKey(a))[this.grid.colDefMgr.length()]);
      this.grid.Pf();
...
(function() {
  function d(a) {
    ...
    this.A = g.ba({background:"#dfdfdf", borderThickness:0, border:"solid #D6D6D6", inputBorder:"solid #A7A7A7", inputBorderThickness:1, inputHeight:18, inputMargin:8, nameMargin:2, font:"12px Arial,Helvetica,sans-serif", height:28, padding:3, classCreatorIcon:"creator-icon", creatorIconUrl:this.grid.A.imageUrl + "data-creator-icon.png", creatorIconWidth:13, creatorIconHeight:13, classCreator:"data-creator", classColName:"data-creator-name", inputBorderRadius:3}, a.options);
    this.Vb = {};
    this.N()
  }
  var g = goog.D("jx.grid"), c = goog.D("jx.util");
...
(function() {
  ...
  b.N = function() {
    ...
    this.cg = $("<div class='" + a.classSearchbar + "'><input type='text'/></div>").appendTo(d);
    this.Pd = this.cg.children(":eq(0)").keyup(function(a) {
      a.which === c.keyMapKeydown.gc ? b.Of($(this)[0].value) : a.which === c.keyMapKeydown.Bg && b.Vf()
    });
    ...
    if(e) {
      ...
      this.Bh = f.children(":eq(0)").click(function() {
    ...
    if(this.hf) {
      for(var e = this.grid.colDefMgr.get(), f = e.length, g = b.keyMap, h = this.Qd, j = this.Gc, i, k, l, m = 0;m < f;m++) {
        if(i = e[m], c.isNotNull(i.filter)) {
          l = i.key, k = c.isNull(g) || !g.hasOwnProperty(l) ? i.name || l : g[l], h[k] = l, j[l] = k, a.push("<div class='" + b.classOptionCol + "'>"), this.Qf(l, k, i.name, i.filter, a), a.push("</div>")
        }
      }
  ...
  var a = d.rd = {lt:0, lte:1, eq:2, neq:3, gt:4, gte:5, and:6, or:7, T:8, F:9}, b = a.Fi, e = a.xi, f = a.eq, i = a.Mi, h = a.je, j = a.Vi, l = a.Ah, a = a.yh, m = d.Eh = {}, k = m[b] = function(a, b) {
    return a <= b
  }, o = m[e] = function(a, b) {
    return a >= b
  }, n = m[f] = function(a, b) {
  ...
  d.ig = [{name:"to", tag:"<=", type:b, comment:function(a, b) {
